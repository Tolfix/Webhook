export interface IssueCommentIssueCommentUser {
    login: string;
    id: number;
    avatar_url: string;
    gravatar_id: string;
...
export interface IssueCommentIssue {
    url: string;
    labels_url: string;
    comments_url: string;
    events_url: string;
...
export interface IssueCommentComment {
    url: string;
    html_url: string;
    issue_url: string;
    id: number;
...
export interface IssueCommentOwner {
    login: string;
    id: number;
    avatar_url: string;
    gravatar_id: string;
...
export interface IssueCommentSender {
    login: string;
    id: number;
    avatar_url: string;
    gravatar_id: string;
